...
Original file is located at
    https://colab.research.google.com/drive/1Pxv5WWy1eJgb96qNfNo3QDEEh8QC5Mfp
"""
...
# 
#     # Sort patients by nearest distance
...
#             schedule.append({
#                 "Patient": p["name"],
#                 "Arrival Time (hrs)": round(arrival_time, 2),
#                 "Distance (km)": round(distance_km, 2)
#             })
#             current_time = arrival_time + 1  # Assume 1 hour consultation
#             start = (p["lat"], p["lon"])
# 
#     if schedule:
...
#         st.table(schedule)
#     else:
#         st.warning("No feasible schedule found based on availability.")